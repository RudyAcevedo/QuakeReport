...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
     ...
     * This really only comes into play if youre using multiple loaders
     */
    private static final int EARTHQUAKE_LOADER_ID = 1;

    //URL fro earthquake data from the USGS dataset
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // so the earthquake_list_activity can be populated in the user interface
        ...
        //Get a reference to the ConnectivtyManger to check state of network connectivity
        ConnectivityManager connMgr = (ConnectivityManager)
                getSystemService(Context.CONNECTIVITY_SERVICE);

        //Get details on the currently active defaut data network
    ...
    public void onLoadFinished(android.content.Loader<List<Earthquake>> loader, List<Earthquake> earthquakes) {
        ...
        View loadingIdicator = findViewById(R.id.loading_indicator);
        loadingIdicator.setVisibility(View.GONE);
        //Set empty state text to display "No Earthqueks found"
        mEmptyStateTextView.setText(R.string.no_earthquakes);
        //Clear the adapter of previous earthquake data
        Log.i(LOG_TAG, "TEST: onLoadFinished() called...");
        mAdapter.clear();

        //If there is a valid list of Earthquakes, then add them to the adapters data set.
