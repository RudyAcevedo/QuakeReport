/**
 * Created by Rudster on 8/23/2016.
 */
...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeaturesFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            //which represent a list of feature (or earthquakes).
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("features");

            //for each earthquake array in the earthquakeArray, create a Earthquake object
            for (int i = 0; i < earthquakeArray.length(); i++){
                //All code in our loop
                ...
                //Create a new Earthquake object with the magnitude, location, time, and url
